...
In this repo, the sync branch is configured as `beads-sync`. Running the daemon while you are on a different branch can cause `.beads/issues.jsonl` to be rewritten from `beads-sync`, leaving your working tree dirty and blocking `git pull --rebase`.
